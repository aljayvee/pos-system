...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When a user registers or logs in, the device asks for verification logic,
    | like a pin, pattern or biometric data. You can set this to "required",
    | "preferred" or "discouraged" depending on your security needs.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | You can limit the authenticator to be "platform" (device-bound) or
    | "cross-platform" (roaming like YubiKey). Default is null (both).
    |
    */
