...
class CreditTest extends TestCase
{
    ...
    public function test_credits_index_loads_and_pay_link_renders()
    {
        ...
        $response = $this->actingAs($this->user)->get(route('credits.index'));
    ...
    public function test_payment_page_loads()
    {
        ...
        $response = $this->actingAs($this->user)->get(route('credits.pay_form', $credit->credit_id));
    ...
    public function test_payment_submission_works()
    {
        ...
        $response = $this->actingAs($this->user)->post(route('credits.pay', $credit->credit_id), [
            'amount' => 200,
            'notes' => 'Test Payment'
        ]);
