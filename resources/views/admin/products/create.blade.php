...
@section('content')
    ...
    <div class="container-fluid px-0 px-md-4 py-0 py-md-4 bg-light h-100">
        ...
        <form id="addProductForm" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data"
            class="pb-5 mb-5 pb-lg-0 mb-lg-0">
            @csrf
            ...
            <div class="row g-0 g-lg-4">
                    ...
                    <div class="card shadow-sm border-0 rounded-0 rounded-lg-4 overflow-hidden mb-3 mb-lg-4 mx-0 mx-md-0">
                        ...
                        <div class="card-body p-3 p-lg-4">
                            ...
                            <div class="row g-2 g-lg-4 mb-3 mb-lg-4">
                                ...
                                @else
                                    <input type="hidden" name="tax_type" value="vatable">
                                @endif
                                ...
                                <div class="col-6 col-md-3">
                                    ...
                                    <input type="text" name="unit" class="form-control bg-light border-0 fw-bold py-3"
                                        list="unitOptions" placeholder="e.g. Pc" required>
                                ...
                                <div class="d-flex align-items-center gap-3 p-3 border-0 bg-light rounded-4">
                                    <div class="rounded-4 d-flex align-items-center justify-content-center bg-white shadow-sm"
                                        ...
                                        <img id="desktopImagePreview" src="#" alt="Preview"
                                            style="display: none; width: 100%; height: 100%; object-fit: cover;">
                                        <i id="desktopPlaceholderIcon"
                                            class="fas fa-image text-secondary fa-2x opacity-50"></i>
                                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group input-group-lg shadow-sm rounded-3 overflow-hidden border-0">
                                        ...
                                        <input type="number" step="0.01" name="price"
                                            class="form-control bg-light border-0 fw-bold fs-4 text-dark" placeholder="0.00"
                                            required>
                                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card shadow-sm border-0 rounded-0 rounded-lg-4 mb-3 mb-lg-4">
                        <div class="card-body p-3 p-lg-4">
                            ...
                            <div class="input-group shadow-sm rounded-3 overflow-hidden d-flex mb-3">
                                <input type="text" id="sku" name="sku" class="form-control bg-light border-0 fw-bold py-3"
                    ...
                    <div class="card shadow-sm border-0 rounded-0 rounded-lg-4 mb-3 mb-lg-4">
                        <div class="card-header bg-white py-3 border-bottom d-none d-lg-block">
                            <h5 class="mb-0 text-dark fw-bold"><i class="fas fa-warehouse me-2 text-warning"></i>Inventory
                            </h5>
                        </div>
                        <div class="card-body p-3 p-lg-4">
                            <div class="row g-2">
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="number" name="stock" class="form-control bg-light border-0 p-3 fw-bold"
                                        value="0">
                                </div>
                                <div class="col-6 mb-3">
                                    <label class="form-label fw-bold small text-secondary">Reorder Pt</label>
                                    <input type="number" name="reorder_point"
                                        class="form-control bg-light border-0 p-3 fw-bold" value="0">
                                </div>
                            </div>
                            <div class="mb-0">
                    ...
                    <div class="d-none d-lg-grid mt-4">
                        <button type="button" id="btn-save-desktop" onclick="validateAndSubmit()"
                            class="btn btn-primary btn-lg shadow-lg rounded-pill fw-bold">
            ...
            <div class="d-lg-none px-3 mt-4 mb-5">
                <button type="button" id="btn-save-mobile" onclick="validateAndSubmit()"
            ...
            <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div class="modal-body bg-black p-0 d-flex justify-content-center align-items-center position-relative">
                    ...
                    <div class="position-absolute text-white text-center w-100 pe-none" style="bottom: 20px; z-index: 10;">
                        <small
                            class="bg-dark bg-opacity-75 px-3 py-1 rounded-pill border border-light border-opacity-25">Align
                            barcode within the frame</small>
                    </div>
                </div>
                <div class="modal-footer p-2 justify-content-center bg-dark border-top-0">
                    <button type="button" class="btn btn-secondary w-100 rounded-pill" onclick="stopScanner()">Close
                        Scanner</button>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4">
                <div class="modal-header bg-warning border-0">
                    <h5 class="modal-title text-dark fw-bold"><i class="fas fa-exclamation-triangle me-2"></i>Duplicate
                        Found</h5>
                </div>
                <div class="modal-body p-4 text-center">
                    ...
                    <p class="text-muted mb-0">This product already exists in the system. Would you like to view or restock
                        it instead?</p>
                </div>
                <div class="modal-footer border-0 justify-content-center pb-4">
                    <button type="button" class="btn btn-light rounded-pill px-4" onclick="handleCancel()">Cancel</button>
                    <button type="button" class="btn btn-primary rounded-pill px-4" onclick="redirectToRestock()">Go to
                        Product</button>
                </div>
            </div>
        </div>
