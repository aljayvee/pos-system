            ...
            <form id="createUserForm" action="{{ route('users.store') }}" method="POST">
                ...
                <div id="stepForm" class="pb-5 mb-5">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-3 p-md-4 bg-white">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control form-control-lg bg-light border-0" placeholder="e.g. Juan Cashier" required style="font-size: 1rem;">
                                </div>
                                <div>
                                    <label class="form-label fw-bold small text-secondary">Email Address</label>
                                    <input type="email" name="email" class="form-control form-control-lg bg-light border-0" placeholder="user@pos.com" required style="font-size: 1rem;">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-3 p-md-4 bg-white">
                                <div>
                                    ...
                                    <select name="role" class="form-select form-select-lg bg-light border-0" style="font-size: 1rem;">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-3 p-md-4 bg-white">
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="password" class="form-control form-control-lg bg-light border-0" required minlength="6" placeholder="••••••••">
                                </div>
                                <div>
                                    <label class="form-label fw-bold small text-secondary">Confirm Password</label>
                                    <input type="password" name="password_confirmation" class="form-control form-control-lg bg-light border-0" required placeholder="••••••••">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-none d-lg-flex justify-content-end mt-4">
                         <button type="submit" id="btnCreateDesktop" class="btn btn-primary rounded-pill px-5 fw-bold shadow-lg">
