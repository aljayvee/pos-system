            ...
            <form id="editUserForm" action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div id="stepForm" class="pb-5 mb-5">
                    ...
                    <div class="px-3 pt-3 d-lg-none bg-white border-bottom pb-3 mb-3">
                         <ul class="nav nav-pills nav-fill gap-2 p-1 bg-light rounded-pill" id="pills-tab-mobile" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link rounded-pill active fw-bold small py-2" id="pills-account-tab-mobile" data-bs-toggle="pill" data-bs-target="#pills-account" type="button" role="tab" aria-selected="true">Account</button>
                            </li>
                            @if(!$isSelfNonAdmin)
                            <li class="nav-item" role="presentation">
                                <button class="nav-link rounded-pill fw-bold small py-2" id="pills-perms-tab-mobile" data-bs-toggle="pill" data-bs-target="#pills-perms" type="button" role="tab" aria-selected="false">Permissions</button>
                            </li>
                            @endif
                        </ul>
                    </div>
                    ...
                    <div class="d-none d-lg-block mb-4">
                        <ul class="nav nav-pills gap-2 p-1 bg-white rounded-pill shadow-sm d-inline-flex" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link rounded-pill active fw-bold small px-4" id="pills-account-tab" data-bs-toggle="pill" data-bs-target="#pills-account" type="button" role="tab" aria-selected="true">Account Details</button>
                            </li>
                            @if(!$isSelfNonAdmin)
                            <li class="nav-item" role="presentation">
                                <button class="nav-link rounded-pill fw-bold small px-4" id="pills-perms-tab" data-bs-toggle="pill" data-bs-target="#pills-perms" type="button" role="tab" aria-selected="false">Permissions <span class="badge bg-warning text-dark ms-1">PRO</span></button>
                            </li>
                            @endif
                        </ul>
                    </div>
                        ...
                        <div class="tab-pane fade show active" id="pills-account" role="tabpanel" aria-labelledby="pills-account-tab">
                            ...
                            <div class="card shadow-sm border-0 rounded-0 rounded-lg-4 mb-3 overflow-hidden">
                                <div class="card-body p-0">
                                    <div class="p-3 bg-light border-bottom d-lg-none">
                                        <h6 class="text-uppercase fw-bold text-muted small mb-0 spacing-1">Personal Info</h6>
                                    </div>
                                    <div class="p-3 p-md-4 bg-white">
                                        <div class="row g-3">
                                            <div class="col-12 col-md-6">
                                                <label class="form-label fw-bold small text-secondary">Full Name</label>
                                                <input type="text" name="name" class="form-control form-control-lg bg-light border-0" value="{{ old('name', $user->name) }}" required style="font-size: 1rem;">
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <label class="form-label fw-bold small text-secondary">Email Address</label>
                                                <input type="email" name="email" class="form-control form-control-lg bg-light border-0" value="{{ old('email', $user->email) }}" required style="font-size: 1rem;">
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label fw-bold small text-secondary">Role</label>
                                                <select name="role" class="form-select form-select-lg bg-light border-0" {{ $isSelfNonAdmin ? 'disabled' : '' }} style="font-size: 1rem;">
                                                ...
                                                @if($isSelfNonAdmin)
                                                    ...
                                                    <div class="form-text text-muted mt-2"><i class="fas fa-lock me-1"></i> You cannot change your own role.</div>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                            ...
                            {{-- SECTION: PASSWORD --}}
                             <div class="card shadow-sm border-0 rounded-0 rounded-lg-4 mb-3 overflow-hidden">
                                <div class="card-body p-0">
                                    <div class="p-3 bg-light border-bottom d-lg-none">
                                        <h6 class="text-uppercase fw-bold text-muted small mb-0 spacing-1">Security Update</h6>
                                    </div>
                                    <div class="p-3 p-md-4 bg-white">
                                        ...
                                        <p class="small text-muted mb-3 d-none d-lg-block">Leave blank to keep current password.</p>
                                        
                                        <label class="form-label fw-bold small text-secondary">New Password</label>
                                        <input type="password" name="password" class="form-control form-control-lg bg-light border-0" placeholder="Leave blank to keep current..." style="font-size: 1rem;">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover align-middle mb-0">
                                        <thead class="bg-light">
                                            <tr>
                                                <th class="small text-uppercase text-secondary py-3 ps-4">Permission</th>
                                                ...
                                                <th class="text-center small text-uppercase text-secondary py-3" style="width: 150px;">Result</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                    ...
                    <div class="d-none d-lg-flex justify-content-end mt-4">
                        <button type="submit" id="btnUpdateDesktop" class="btn btn-warning rounded-pill px-5 fw-bold shadow-lg">
                ...
                <div class="d-lg-none mt-4 pb-5">
                    <button type="submit" id="btnUpdateMobile" class="btn btn-primary w-100 rounded-pill fw-bold py-3 shadow-lg" style="font-size: 1.1rem;">
                        Save Changes
                    </button>
                </div>
            </form>
