...
<div class="container-fluid px-2 py-3 px-md-4 py-md-4">
    ...
    <div class="d-flex flex-column flex-xl-row justify-content-between align-items-xl-center mb-4 gap-3">
        ...
        <div class="d-flex flex-wrap gap-2">
            <a href="{{ route('reports.index') }}" class="btn btn-primary shadow-sm flex-fill flex-xl-grow-0 rounded-pill fw-bold px-4">Sales</a>
            ...
            <div class="card shadow-sm border-0 h-100 rounded-4 overflow-hidden">
                ...
                <div class="d-md-none p-2">
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item p-3 border-0 bg-light rounded-4 mb-2">
