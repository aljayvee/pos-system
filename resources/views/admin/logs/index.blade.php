...
<div class="container-fluid px-2 py-3 px-md-4 py-md-4">
            ...
            <form action="{{ route('logs.index') }}" method="GET" class="row g-2 align-items-center">
                <div class="col-12 col-md-4">
                    <div class="input-group">
                        ...
                        <input type="text" name="search" class="form-control bg-light border-0" placeholder="Search logs..." value="{{ request('search') }}">
                    </div>
                </div>
                ...
                <div class="col-12 col-md-2">
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary shadow-sm w-100 fw-bold">Filter</button>
                        <a href="{{ route('logs.index') }}" class="btn btn-light border w-100" title="Reset"><i class="fas fa-undo"></i></a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="card shadow-sm border-0 rounded-4 overflow-hidden mb-4">
        ...
        <div class="d-lg-none bg-white p-4">
            <div class="timeline border-start border-2 border-light ms-2">
                @forelse($logs as $log)
                <div class="position-relative pb-4 ps-4">
                    ...
                    @endphp
                    <div class="position-absolute bg-white border border-2 border-{{ $color }} rounded-circle shadow-sm" style="width: 14px; height: 14px; left: -8px; top: 4px;"></div>
                    
                    <div class="card shadow-sm border-0 bg-light rounded-4 mb-2">
