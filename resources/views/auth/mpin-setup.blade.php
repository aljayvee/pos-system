...
@section('content')
    <div class="text-center mb-8">
        <h2 class="text-2xl font-bold text-gray-900">Create MPIN</h2>
    ...
    <form id="mpin-setup-form" class="space-y-6" action="{{ route('auth.mpin.store') }}" method="POST">
            ...
            <div class="animate-shake rounded-xl bg-red-50 border border-red-100 p-4 mb-6 relative overflow-hidden">
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-4 flex-1">
                        <h3 class="text-sm font-bold text-red-900">Setup Failed</h3>
        ...
        <div class="space-y-4">
            <div>
                <label for="mpin" class="block text-sm font-medium text-gray-700 mb-1">Enter New MPIN</label>
            ...
            <div>
                <label for="mpin_confirmation" class="block text-sm font-medium text-gray-700 mb-1">Confirm MPIN</label>
    ...
    <div class="mt-8 pt-6 border-t border-gray-100 text-center text-sm">
        <p class="text-gray-500 mb-2">Want to sign in as a different user?</p>
