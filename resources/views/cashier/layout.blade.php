    ...
    <nav class="navbar navbar-dark shadow-sm py-2 sticky-top d-none d-lg-block">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <a class="navbar-brand fw-bold d-flex align-items-center" href="#">
                <div class="bg-warning text-dark rounded-3 d-flex align-items-center justify-content-center me-2"
            ...
            <ul class="navbar-nav ms-auto d-none d-lg-flex flex-row align-items-center gap-3">
                @if(Auth::user()->role !== 'cashier')
                    <li class="nav-item">
                        <a class="btn btn-outline-light btn-sm fw-medium rounded-pill px-3 opacity-75 hover-opacity-100"
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-white fw-medium d-flex align-items-center gap-2" href="#"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4 mt-2 p-2">
                        <li><a class="dropdown-item rounded-3"
                                href="{{ route('profile.edit', ['context' => 'cashier']) }}">Profile Settings</a></li>
                        <li>
            ...
            <button class="navbar-toggler border-0 p-1 d-lg-none" type="button" data-bs-toggle="offcanvas"
    ...
    <div class="offcanvas offcanvas-start border-0" tabindex="-1" id="mobileNavDrawer"
        ...
        <div class="offcanvas-body p-0 bg-light d-flex flex-column">
            <div class="list-group list-group-flush bg-transparent mt-2">
                ...
                <button
                    class="list-group-item list-group-item-action py-3 px-4 border-0 bg-transparent d-flex align-items-center gap-3"
                    onclick="bootstrap.Offcanvas.getInstance(document.getElementById('mobileNavDrawer')).hide(); requestAdminAuth(openDebtorList);">
                ...
                <button
                    class="list-group-item list-group-item-action py-3 px-4 border-0 bg-transparent d-flex align-items-center gap-3"
                    onclick="bootstrap.Offcanvas.getInstance(document.getElementById('mobileNavDrawer')).hide(); requestAdminAuth(openReturnModal);">
                    <i class="fas fa-undo text-secondary w-25px text-center"></i>
                    <span class="fw-medium text-dark">Return Items</span>
                </button>

                <button id="btn-close-register-mobile"
                    class="list-group-item list-group-item-action py-3 px-4 border-0 bg-transparent d-flex align-items-center gap-3"
                    onclick="bootstrap.Offcanvas.getInstance(document.getElementById('mobileNavDrawer')).hide(); showCloseRegisterModal();">
